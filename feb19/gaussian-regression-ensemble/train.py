...
model_id = "gaussian-regression-ensemble_1"
...
M = 10 # (number of networks in the ensemble)
for i in range(M):
    network = ToyNet(model_id + "_%d" % i, project_dir="/root/blog/feb19/gaussian-regression-ensemble").cuda()
